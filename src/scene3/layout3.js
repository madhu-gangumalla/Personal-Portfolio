...
export const YEARS = [
  {
    ...
    img: 2021,
    key: 'Starting Point',
    lines: ['B.Sc Computer Science', 'Learning the basics', 'Curiosity sparked'],
  },
  {
    year: 2025,
    img: 2022,
    key: 'Web Developer',
    lines: ['HTML, CSS, JS', 'Learned React', 'Built real pages'],
  },
  {
    year: 2025,
    img: 2023,
    key: 'Discovering AI',
    lines: ['ChatGPT, Claude, Gemini', 'AI-assisted building', 'A new way to work'],
  },
  {
    year: 2025,
    img: 2024,
    key: 'AI Tools Explorer',
    lines: ['Base44, Bolt, Cursor', 'Replit, Lovable', 'Finding what fits'],
  },
  {
    year: 2026,
    img: 2025,
    key: 'Product Builder',
    lines: ['Ganga Saathi', 'EduPartner, DineFlow', 'Idea to shipped'],
  },
  {
    year: 2026,
    img: 2026,
    key: 'Pathora',
    lines: ['AI career platform', 'Cinematic 3D scroll', 'Founder & Developer'],
  },
];
